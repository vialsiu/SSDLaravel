    ...
    <div class="relative w-full max-w-none px-6 lg:px-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
        ...
        <div>
            ...
            <p class="text-gray-300 text-sm">
                Dedicated to exploring and bringing traction to famous art.
            </p>
        </div>
        ...
        <div>
            ...
            <div class="w-12 border-b-2 border-white my-2"></div>
            <p class="text-gray-300 text-sm">
                How the eras influenced art and vice versa.
            </p>
        </div>
        ...
        <div>
            ...
            <div class="w-12 border-b-2 border-white my-2"></div>
            <p class="text-gray-300 text-sm">
                Exploring how culture and geographical location influences creation.
            </p>
        </div>

    </div>
</div>
<?php /**PATH C:\Users\fedan\Pictures\2nd Year Work\Paint Across the World\resources\views/partials/collections.blade.php ENDPATH**/ ?>