...
<div class="w-4/5 m-auto text-center pt-20">
    <h1 class="text-5xl font-extrabold tracking-wide text-gray-900 uppercase"><?php echo e($post->title); ?></h1>
</div>
...
<div class="w-4/5 m-auto pt-3">
    ...
    <div class="w-4/5 m-auto pt-5">
        ...
        <p class="text-xl text-gray-700 pt-5 pb-20"><?php echo e($post->description); ?></p>
    </div>
</div>
