<div class="container mx-auto text-center py-16 px-6 lg:px-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div class="text-center">
            <img src="<?php echo e(asset('images/backgroundpic.jpeg')); ?>"  class="w-full h-64 object-cover rounded-lg shadow-md">
        ...
        <!-- Card 3: What's On -->
        <div class="text-center">
            <img src="<?php echo e(asset('images/backgroundpic.jpeg')); ?>" alt="What's On" class="w-full h-64 object-cover rounded-lg shadow-md">
            <h3 class="text-xl font-medium text-gray-900 mt-4 relative pb-2 after:block after:w-10 after:border after:border-gray-300 after:mt-2 after:mx-auto">
                What's on
            </h3>
